	...
	<div id="main-container">
		...
		<body>
			...
			<div id="confirm">
				...
				<?php if($_COOKIE[$cookie_name] == "chocolate") { ?>
				...
				<h5 style="text-align: left">Your order has been confirmed. Please click "Download" to download your chocolate digital recipe book.</h5>
				
				<a href="digitalRecipes/chocolate.zip" download><img src="photos/downloadButton.png" alt="download"></a>
